...
const Nav = () => {
    ...
    return (
        <nav className={`${checkPath} bg-dark/5 backdrop-blur-[5rem]`}>
            <div className="cont flex justify-between items-center pb-[1rem] pt-[1.7rem] md:pt-[3rem] md:grid md:grid-cols-[45%_55%]">
                <Logo />
